...
<html lang="en">
  ...
  <body>
  	...
  	<h2 style="text-align: center; margin-top: 20px;">Criar Novo Usuario</h2>
    ...
    <div class="container">
    	<form  method="POST" action="" id="form-novo">
            ...
            <div class="form-group">
    			...
    			<input type="usuario" class="form-control" name="usuario" id="input-usuario" placeholder="Digite o nome do usuario" required="required">
    		</div>
